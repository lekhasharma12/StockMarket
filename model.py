...
ind = date_list.get_loc(predict_date) - 11000

running_mean = running_mean*decay + (1.0-decay)*test_data[ind-1]
predict_x = running_mean
predict_x = predict_x.reshape(1,1)
predict_x = scaler.inverse_transform(predict_x)
actual_x = test_data[ind].reshape(1,1)
print("Predicted value : ", predict_x)
print("Actual value : ", scaler.inverse_transform(actual_x))'''